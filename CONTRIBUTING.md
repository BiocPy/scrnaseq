...
Welcome to `scrnaseq` contributor's guide.
...
If you experience bugs or general issues with `scrnaseq`, please have a look
...
You can help improve `scrnaseq` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`scrnaseq` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `scrnaseq`'s files. While this mechanism can
...
```
conda create -n scrnaseq python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/scrnaseq.git
   cd scrnaseq
   ```
...
5. Install [pre-commit]:
   ...
   `scrnaseq` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/scrnaseq
[issue tracker]: https://github.com/<USERNAME>/scrnaseq/issues
