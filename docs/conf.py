...
module_dir = os.path.join(__location__, "../src/scrnaseq")
try:
...
try:
    from scrnaseq import __version__ as version
except ImportError:
    version = ""
...
latex_documents = [
    ("index", "user_guide.tex", "scrnaseq Documentation", "Jayaram Kancherla", "manual")
]
